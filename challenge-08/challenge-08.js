...
no console.
*/
console.log(subtraction(159,56));//Resultado da operação: 159 - 56 =  103.
console.log(multiplication(525,652));//Resultado da operação: 525 * 652 =  342300.
console.log(division(36,4));//Resultado da operação: 36 / 4 =  9.
