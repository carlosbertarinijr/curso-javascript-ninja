...
var fullName = 'naruto-ninja-br-louco';
var newFulName = fullName.split( '-' ).map(function(item){
...
*/
console.log( '\nMeus amigos:' );
var arr = ['NaN', 'null', 'undefined','{}', '[]'];
var newArr=  arr.reduce(function(acumulador, atual, index) {
  var separator = arr.length -1 === index ?' e ': ', ';
  return acumulador + separator + atual;
});

console.log(newArr +' são meus amigos');
/*
